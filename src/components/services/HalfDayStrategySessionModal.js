      ...
      <div className="bg-bone max-w-6xl w-full max-h-[90vh] rounded-lg shadow-xl overflow-hidden">
        ...
        <div className="bg-charcoal text-bone p-6 relative">
          ...
          <div className="flex items-center space-x-4 mb-4">
            <Brain className="w-12 h-12 text-chestnut" />
        ...
        <div className="overflow-y-auto max-h-[calc(90vh-200px)]">
          ...
          <div className="p-6 bg-white">
            <div className="text-center mb-8">
              ...
              <p className="text-lg text-khaki max-w-4xl mx-auto">
          ...
          <div className="p-6 bg-bone">
            <h2 className="text-3xl font-serif font-bold text-charcoal text-center mb-6">
              3–4 Hour Interactive Workshop
            </h2>
            <p className="text-lg text-center text-khaki mb-8">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-khaki">{section.description}</p>
                          <div className="flex items-center space-x-2 mt-1">
                            <Clock className="w-4 h-4 text-chestnut" />
                            <span className="text-sm text-charcoal">{section.duration}</span>
                          </div>
                        </div>
                      </div>
                      <div>
                        {activeWorkshop === section.id ? 
                          <ChevronDown className="w-5 h-5 text-chestnut" /> : 
                          <ChevronRight className="w-5 h-5 text-chestnut" />
                        }
                      </div>
                    </div>
                  </div>
            ...
            <div className="text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                ...
                <button className="border-2 border-pearl text-pearl px-6 py-3 rounded-lg hover:bg-pearl hover:text-charcoal transition-colors flex items-center justify-center space-x-2">
                  ...
                  <span>Download Workshop Guide</span>
                </button>
              </div>
            </div>
          </div>
