        ...
        {activeTab !== 'overview' && activeTab !== 'subscribers' && (
          <div className="bg-white rounded-lg shadow-sm p-12 text-center">
            ...
            <p className="text-gray-600 mb-6">
              This admin module is under development. Full functionality will be available soon.
            </p>
            <button className="px-6 py-3 bg-chestnut text-white rounded-lg hover:bg-chestnut/90 transition-colors">
              Configure Module
            </button>
          </div>
        )}
